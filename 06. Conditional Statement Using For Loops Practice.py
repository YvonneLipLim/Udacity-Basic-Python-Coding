...
for name in names: #iterates over each name in the names list
    lowercase_name = name.lower().replace(" ", "_") #converts the name to lowercase and replaces all spaces in the name with underscores
...
'''
Q2. Given the input name list as below, modify it to a usernames list with everything lowercase and replace spaces with underscores running in for loop over the list.
names =["Katharine Hepburn", "Meryl Streep", "Jack Nicholson", "Ingrid Bergman", "Daniel Day-Lewis", "Frances McDormand", "Walter Brennan", "Bette Davis", "Spencer Tracy", "Marlon Brando"]
'''
...
#Q3. Create a for loop that iterates over a list of strings, tokens, and counts how many of them are XML tags(opens in a new tab). Keep track of the number of tags using the variable count.
